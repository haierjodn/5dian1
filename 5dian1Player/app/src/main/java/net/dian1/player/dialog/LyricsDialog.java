...
public class LyricsDialog extends Dialog {
	...
	public LyricsDialog(Activity context, Music music) {
		super(context);
		init(context, music);
	}
	 ...
	 * @param music
	 */
	private void init(Activity context, Music music){
		mActivity = context;
	 ...
	 * @author Lukasz Wisniewski
	 */
	private class LyricsTask extends AsyncTask<Music, WSError, String>{

		@Override
		public String doInBackground(Music... params) {
