...
public class PlaylistAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(holder.songRating != null){
			...
			holder.songRating.setProgress((int) (playlistEntry.getMusic().getRating()*10));
		}
		holder.songDuration.setText(Helper.secondsToString(playlistEntry.getMusic().getDuration()));
