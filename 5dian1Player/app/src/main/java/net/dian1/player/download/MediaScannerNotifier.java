...
import net.dian1.player.service.DownloadService;
...
public class MediaScannerNotifier implements MediaScannerConnectionClient{
	...
	public void onMediaScannerConnected() {
		...
		Log.i(Dian1Application.TAG, "Adding to media library -> "+fileName);
	...
	public void onScanCompleted(String text, Uri uri) {
		Log.i(Dian1Application.TAG, "Added to media library -> "+uri.toString());
