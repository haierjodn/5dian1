...
public interface JamendoGet2Api {
	 ...
	 * @return a <code>Music</code> array from the given album
	 * @throws JSONException
	 * @throws WSError 
	 */
	Music[] getAlbumTracks(Album album, String encoding) throws JSONException, WSError;

	/**
	 * Retrieve info on tracks from the given album using pagination.
	 * Tracks retrieved from given page will be appended to existing <code>Album</code> <code>Music</code>s
	 ...
	 * @throws WSError 
	 */
	Music[] getAlbumTracks(Album album, String encoding, int count, int page) throws JSONException, WSError;
	 ...
	 * @throws WSError 
	 */
	Music[] getTracksByTracksId(int id[], String encoding) throws JSONException, WSError;
	 ...
	 * @throws WSError 
	 */
	String getTrackLyrics(Music music) throws WSError;
